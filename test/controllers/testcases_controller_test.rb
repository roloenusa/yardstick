...
class TestcasesControllerTest < ActionController::TestCase
  ...
  test "should create testcase" do
    assert_difference('Testcase.count') do
      post :create, testcase: { description: @testcase.description, steps: @testcase.steps, title: @testcase.title }
    end
  ...
  test "should update testcase" do
    patch :update, id: @testcase, testcase: { description: @testcase.description, steps: @testcase.steps, title: @testcase.title }
    assert_redirected_to testcase_path(assigns(:testcase))
  end
